<html>
    ...
    <div class="row styleRow1">
         ...
         <h4 align="center">Bienvenido Usuario </h4> 
           <br><h2 align="center" style="background-color:#8A084B"><font color=White>Reservaciones creadas</font></h2></br>
</head>
<body>
<div class="container">
        <div class="RoDate">
        ...
        <section>
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <td>Otto</td>
                    <td>@mdo</td>
                    <td><p class="text-success">Aprobada</p></td>
                    ...
                    <td><p class="text-danger">Rechazada</p></td>
                    </tr>
                    <tr>
                    <th scope="row">3</th>
                    <td>Larry</td>
