<div class="container">
  ...
  <br><h2 align="center" style="background-color:#8A084B"><font color=White>Crear tipos de cancha</font></h2></br>
  ...
  <form>
	...
	<div class="modal fade" id="btnConfirmar" role="dialog">
		...
		<div class="modal-content">
			...
			<p align="center">Tipo de cancha se ha creado con Éxito!
				<p>Fecha de creación: </p>
				<p>Usuario que realizó la creación de tipo de cancha:</p>
			</div>
