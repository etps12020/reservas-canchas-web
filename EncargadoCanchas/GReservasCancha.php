<html>
    <head>
	<title>Gestión de reservas de cancha</title>
    ...
    <div class="row styleRow1">
         ...
         <h4 align="center">Bienvenido Encargado de canchas </h4> 
           <br><h2 align="center" style="background-color:#8A084B"><font color=White>Gestión de reservas de cancha</font></h2></br>
</head>
<body>
<div class="container">
        <div class="RoDate">
        ...
        <section>
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <td><button type="button" class="btn btn-outline-danger">Rechazar</button></td>
                    </tr>
                    <tr>
                    <th scope="row">2</th>
                    <td>Jacob</td>
